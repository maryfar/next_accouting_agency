...
export default function Login() {
  ...
  return (
    <main className="w-full h-screen flex md:flex-row  justify-center items-center flex-col px-xs sm:px-0">
      ...
      <div className="shadow-card rounded-sm sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12" >
        <img src="/Clip path group.png" alt="" className="w-full sm:w-full h-[550px]" />
      </div>
    </main>
  );
}
